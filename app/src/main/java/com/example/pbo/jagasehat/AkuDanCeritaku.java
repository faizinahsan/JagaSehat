...
public class AkuDanCeritaku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aku_dan_ceritaku);
//        Masih dalam tahap perkembangan
//        onSaveInstanceState(savedInstanceState);
//        onRestoreInstanceState(savedInstanceState);
        ImageView imageIsi =  (ImageView) findViewById(R.id.imgIsi);
        imageIsi.setImageResource(R.drawable.akudanceritaku);
...
//Masih dalam tahap perkembangan
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("MyString", isiCerita);
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        editCerita.setVisibility(View.GONE);
        isiTextCerita.setVisibility(View.VISIBLE);
        isiTextCerita.setText(myString);
    }
}
